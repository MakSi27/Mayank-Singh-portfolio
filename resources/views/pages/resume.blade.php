      ...
      >
        ...
        <div class="container py-3 px-0">
          <a
            ...
            /><span class="fs-4 ms-2 site-name-text">william.design</span></a
          >
            ...
            <div class="d-none d-md-flex">
              <div class="dropdown language-dropdown">
                <button
                  ...
                  type="button"
                  id="language-dropdown-button-1770725035"
                ...
                <ul
                  class="dropdown-menu"
                  aria-labelledby="language-dropdown-button-1770725035"
                >
                  <li>
                    <a
                      ...
                      >
                        ...
                        <span class="ms-2">Tiếng Việt</span></a
                    >
                  </li>
                  <li>
                    <a
        ...
        <div class="row align-items-end py-60">
          ...
          <div class="col-lg-5 ps-lg-5 text-lg-start text-center">
            <div class="position-relative mb-lg-0 mb-5">
              <img
                src="asset/hero-man.png"
                data-bb-lazy="true"
                loading="lazy"
                alt="Data Science & AI Enthusiast"
              />
              <div
                class="position-absolute end-0 top-100 translate-middle-y icon-decorate"
              >
                <img
                  src="asset/hero-decorate.png"
                  data-bb-lazy="true"
                  width="80px"
                  loading="lazy"
                  alt="Data Science & AI Enthusiast"
          ...
          <div class="mx-lg-auto col-md-12 col-lg-6">
