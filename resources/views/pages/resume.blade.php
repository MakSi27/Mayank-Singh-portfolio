...
<html data-bs-theme="dark" lang="en" style="scroll-behavior: smooth">
  <head>
    ...
    <meta
      ...
      name="viewport"
    />
    <title>Showcasing Creative Designs and Innovative Projects</title>
    <meta
      name="description"
    ...
    <meta
      ...
      content="Showcasing Creative Designs and Innovative Projects"
    />
    ...
    <style>
      @font-face {
        ...
        font-weight: 300;
        font-display: swap;
        src: url(asset/surbanistv15l0x-df02ifml4hgcymqrbs1mixk2z7s.woff2)
          format("woff2");
        unicode-range:
      ...
      @font-face {
        ...
        font-weight: 300;
        font-display: swap;
        src: url(asset/surbanistv15l0x-df02ifml4hgcymqlbs1mixk2.woff2)
          format("woff2");
        unicode-range:
    ...
    <link
      ...
      type="text/css"
      rel="stylesheet"
      href="asset/language-public.css"
    />
    <link
      media="all"
      type="text/css"
      rel="stylesheet"
      href="asset/content-styles.css"
    />
    <link
      media="all"
      type="text/css"
    ...
    <link
      ...
      type="text/css"
      rel="stylesheet"
      href="asset/odometer.css"
    />
    <link
      media="all"
      type="text/css"
      rel="stylesheet"
      href="asset/carouselTicker.css"
    />
    <link
      media="all"
      type="text/css"
      rel="stylesheet"
      href="asset/slick.css"
    />
    <link
      media="all"
      type="text/css"
      rel="stylesheet"
      href="asset/magnific-popup.css"
    />
    <link
      media="all"
      type="text/css"
      rel="stylesheet"
      href="asset/remixicon.css"
    />
    <link
      media="all"
      type="text/css"
    ...
    <link href="{{asset('/')}}" hreflang="vi" rel="alternate" />
    <link href="{{asset('/')}}" hreflang="ar" rel="alternate" />
    <link
    ...
    <script
      async=""
      defer=""
      src="https://www.googletagmanager.com/gtag/js?id=G-76NX8HY29D"
    ></script>
    <script>
    ...
    <style>
      .page_speed_1711549805 {
        max-height: 40px !important;
      }

      .page_speed_213802320 {
        height: 16px;
        width: auto;
      }

      .page_speed_1912032830 {
        display: none;
      }

      .page_speed_1318966020 {
        translate: none;
        rotate: none;
        scale: none;
      ...
      .page_speed_1011913157 {
        visibility: visible;
        animation-name: img-anim-top;
      }

      .page_speed_399634552 {
        background-color: #000;
        color: #fff;
      }

      .page_speed_1307486709 {
        max-width: 1170px;
      }

      .page_speed_2100131830 {
        background-color: #fff;
        color: #000;
        border: 1px solid #fff;
      }

      .page_speed_1755834137 {
        background-color: #000;
        color: #fff;
        border: 1px solid #fff;
      }
...
@section('main_content')
  ...
  >
    ...
    <header>
      <nav
        class="navbar navbar-expand-lg navbar-light w-100 flex-nowrap z-999 p-0"
      ...
      >
        ...
        <div class="container py-3 px-0">
          <a
            class="navbar-brand d-flex main-logo align-items-center ms-lg-0 ms-md-5 ms-3"
            href="{{asset('/')}}"
            ><span class="fs-4 ms-2 site-name-text"></span></a
          >
          ...
          <div
            class="navbar-social d-flex align-items-center pe-5 pe-lg-0 me-5 me-lg-0 gap-3"
          >
            ...
            <div class="d-none d-lg-flex gap-3">
              ...
              ><a href="https://www.youtube.com" title="YouTube" target="_blank"
                ...
                >
                  ...
                  ></path>
                  <path d="M10 9l5 3l-5 3l0 -6"></path></svg></a
              ><a
        ...
        <div
          class="dark-light-switcher pe-0 ps-md-5 ps-0 ps-lg-4 pe-lg-4 d-flex justify-content-center align-items-center icon_80"
        >
          <i class="ri-sun-fill text-warning" style="display: block"></i
          ><i class="ri-contrast-2-line text-white" style="display: none"></i>
        </div>
      </nav>
      <div class="offCanvas__info">
        ...
        <div class="offCanvas__logo mb-5">
          <div class="mb-0"><span class="h3">Get in touch</span></div>
        </div>
        <div class="offCanvas__side-info mb-30">
          <div class="contact-list mb-30">
            ...
            <div class="mb-3">
              <span class="text-400 fs-5">Phone</span>
              <p class="mb-0">+1 234 567 890</p>
            </div>
            <div class="mb-3">
              <span class="text-400 fs-5">Email</span>
              <p class="mb-0">contact@botble.com</p>
            </div>
            <div class="mb-3">
              <span class="text-400 fs-5">Website</span>
              <p class="mb-0">https://botble.com</p>
            </div>
            <div class="mb-3">
              <span class="text-400 fs-5">Address</span>
              <p class="mb-0">123 Main Street, New York, NY 10001</p>
            </div>
          </div>
          ...
          <div class="mt-5">
            <div class="dropdown language-dropdown">
              <button
                class="btn btn-secondary dropdown-toggle language-dropdown-button"
                type="button"
                id="language-dropdown-button-1770725034"
              ...
              >
                <svg
                  ...
                  height="15"
                  fill="none"
                  class="page_speed_213802320 flag"
                >
                  <mask
                    id="flags_us_a"
                    width="20"
              ...
              <ul
                class="dropdown-menu"
                aria-labelledby="language-dropdown-button-1770725034"
              >
                <li>
                  <a
                    ...
                    >
                      ...
                      </g></svg><span class="ms-2">Tiếng Việt</span></a
                  >
                </li>
                <li>
                  <a
      ...
      >
        <div class="mobile-header-wrapper-inner">
          <div class="mobile-header-logo">
            <a
              class="d-flex main-logo align-items-center d-inline-flex"
              href="{{asset('/')}}"
              ><img
                src="asset/logo-dark.png"
                data-bb-lazy="false"
                class="page_speed_1711549805"
                alt="Showcasing Creative Designs and Innovative Projects"
              /><span class="fs-4 ms-2 site-name-text text-dark"
                >william.design</span
              ></a
            >
            <div class="burger-icon burger-icon-white border rounded-3">
                  ...
                  <ul class="mobile-menu font-heading ps-0">
                    <li class="nav-item has-children active">
                      <span class="menu-expand"
                        ><i class="arrow-small-down"></i></span
                      ><a
                        class="nav-link"
                        href="{{asset('/')}}"
                        target="_self"
    ...
    <div class="border border-1 rounded-3">
      <div class="box-linear-animation position-relative z-1">
        <div class="row align-items-end py-60">
          ...
          <div class="col-lg-3 ps-lg-5 text-lg-start text-center">
            <div class="mb-lg-0 mb-5" style="display: flex;justify-content: center;">
              <div style="
    position: relative;
    display: flex;
    flex-direction: column;
"><img src="asset/mayank.png" data-bb-lazy="true" loading="lazy" alt="Data Science &amp; AI Enthusiast">
              
                <img src="asset/hero-decorate.png" class=" translate-middle-y icon-decorate" data-bb-lazy="true" width="80px" loading="lazy" alt="Data Science &amp; AI Enthusiast" style="
    margin: auto;
">
              </div>
            </div>
          ...
          <div class="mx-lg-auto col-md-12 col-lg-8">
            <div class="p-lg-0 p-md-8 p-3">
              ...
              <h1 class="fs-50 my-3 section-hero-title">
                Data Science, AI & ML
                <span class="text-primary">Driven Problem Solver</span
                ><span class="flicker">_</span>
              </h1>

              <p class="mb-6 text-secondary-2">
                &lt;p&gt;
                <span class="text-dark section-hero-description">
                  B.Tech student with a strong passion for Data Science,
                  Artificial Intelligence, and Machine Learning. I enjoy working
                  with real-world datasets, building predictive models, and
                  extracting meaningful insights using Python, SQL, and
              ...
              <div class="row">
                <div class="col-7">
                  ...
                  >
                    ...
                    >
                      <ul
                        class="carouselTicker__list"
                        style="width: 960px; position: relative;"
                      >
                        <li class="carouselTicker__item">
                          <div class="brand-logo icon_60 icon-shape rounded-3">
                            <img src="asset/1.png" loading="lazy" alt="Python" />
                          </div>
                        </li>
                        <li class="carouselTicker__item">
                          <div class="brand-logo icon_60 icon-shape rounded-3">
                            <img src="asset/2.png" loading="lazy" alt="SQL" />
                          </div>
                        </li>
                        <li class="carouselTicker__item">
                          <div class="brand-logo icon_60 icon-shape rounded-3">
                            <img src="asset/3.png" loading="lazy" alt="Pandas & NumPy" />
                          </div>
                        </li>
                        <li class="carouselTicker__item">
                          <div class="brand-logo icon_60 icon-shape rounded-3">
                            <img src="asset/4.png" loading="lazy" alt="Machine Learning" />
                          </div>
                        </li>
                        <li class="carouselTicker__item">
                          <div class="brand-logo icon_60 icon-shape rounded-3">
                            <img src="asset/5.png" loading="lazy" alt="Data Visualization" />
                          </div>
                        </li>
                        <li class="carouselTicker__item">
                          <div class="brand-logo icon_60 icon-shape rounded-3">
                            <img src="asset/6.png" loading="lazy" alt="AI Tools" />
                          </div>
                        </li>
                      </ul>
                    </div>
                ...
                <div class="col-5 d-flex align-items-end">
                  <span class="fs-6 text-300 mb-2">
                    Hands-on experience with Data Analysis & ML projects
                  </span>
                </div>
              </div>
              <a
                href="{{asset('asset/Mayank_Resum.pdf')}}"
                class="btn me-2 text-300 ps-0 mt-4"
                target="_blank"
              >
                <svg
                  class="icon text-primary-2 svg-icon-ti-ti-download"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <a href="#contact" class="btn me-2 text-300 ps-0 mt-4">
                <svg
                  class="icon text-secondary-2 svg-icon-ti-ti-arrow-right"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
  ...
  <div class="background position-absolute top-0 start-0 w-100 h-100">
    <img
      ...
      class="bg-w"
      loading="lazy"
      alt="Data Science Portfolio Background"
    />
  </div>
</section>
  ...
  <div class="container">
    <div class="inner">
        ...
        <div class="col-lg-auto col-md-6">
          <div class="counter-item-cover counter-item">
            <div class="content text-center mx-auto d-flex align-items-center">
              <span class="ds-3 count text-primary fw-medium my-0 counter-wrapper">
                <span class="plus-icon-counter">+</span>
                <span class="odometer ds-1 text-dark fw-semibold number-counter">2</span>
              </span>
              <div class="text-start ms-2">
                <p class="fs-5 mb-0 text-300">Years of</p>
                <p class="fs-5 mb-0 fw-bold">Learning & Practice</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-auto col-md-6">
          <div class="counter-item-cover counter-item">
            <div class="content text-center mx-auto d-flex align-items-center">
              <span class="ds-3 count text-primary fw-medium my-0 counter-wrapper">
                <span class="plus-icon-counter">+</span>
                <span class="odometer ds-1 text-dark fw-semibold number-counter">15</span>
              </span>
              <div class="text-start ms-2">
                <p class="fs-5 mb-0 text-300">Academic & Personal</p>
                <p class="fs-5 mb-0 fw-bold">Projects Built</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-auto col-md-6">
          <div class="counter-item-cover counter-item">
            <div class="content text-center mx-auto d-flex align-items-center">
              <span class="ds-3 count text-primary fw-medium my-0 counter-wrapper">
                <span class="plus-icon-counter">+</span>
                <span class="odometer ds-1 text-dark fw-semibold number-counter">8</span>
              </span>
              <div class="text-start ms-2">
                <p class="fs-5 mb-0 text-300">Datasets &</p>
                <p class="fs-5 mb-0 fw-bold">Case Studies</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-auto col-md-6">
          <div class="counter-item-cover counter-item">
            <div class="content text-center mx-auto d-flex align-items-center">
              <span class="ds-3 count text-primary fw-medium my-0 counter-wrapper">
                <span class="plus-icon-counter">+</span>
                <span class="odometer ds-1 text-dark fw-semibold number-counter">5</span>
              </span>
              <div class="text-start ms-2">
                <p class="fs-5 mb-0 text-300">Certifications &</p>
                <p class="fs-5 mb-0 fw-bold">Skill Badges</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section
  data-shortcode-id="sc_1770725038_0"
  data-shortcode-name="services"
  class="section-service-1 pt-120 pb-120 shortcode-lazy-loading-loaded">
  <div class="container">
    <div class="row align-items-end">
      <div class="col-lg-7 me-auto">
        <h3 class="ds-3 mt-3 mb-3 text-primary">What do I offer?</h3>
        <span class="fs-5 fw-medium text-200">
          My journey started with curiosity for data and intelligence, leading me
          to build solutions using Data Science, Machine Learning, and AI.
        </span>
      </div>
    </div>
    ...
    <div class="row mt-6 justify-content-between">
      <div class="col-12">
        <div
          class="single-service-card-1 tg-img-reveal-item w-100 border-top border-900 p-3"
          data-fx="1"
          data-img="asset/41.png">
          <div class="service-card-details d-lg-flex align-items-center">
            ...
            <a
              ...
              <p class="service-card-text my-3">
                Extracting insights from structured data using Python, Pandas,
                <br />
                NumPy, Matplotlib, and real-world datasets.
              </p>
              <div
                class="service-card-icon icon-shape ms-auto icon-md rounded-circle border">
        ...
        <div
          ...
          <div class="service-card-details d-lg-flex align-items-center">
            ...
            <a
              ...
              class="d-md-flex d-block ps-lg-10 align-items-center justify-content-end w-100">
              <p class="service-card-text my-3">
                Building predictive models using supervised and unsupervised
                <br />
                learning algorithms with Scikit-learn.
              </p>
              <div
                class="service-card-icon icon-shape ms-auto icon-md rounded-circle border">
                <i class="ri-arrow-right-up-line"></i>
        ...
        <div
          ...
          <div class="service-card-details d-lg-flex align-items-center">
            ...
            <a
              ...
              class="d-md-flex d-block ps-lg-10 align-items-center justify-content-end w-100">
              <p class="service-card-text my-3">
                Training and evaluating AI models with focus on accuracy,
                <br />
        ...
        <div
          ...
          <div class="service-card-details d-lg-flex align-items-center">
            ...
            <a
              ...
              class="d-md-flex d-block ps-lg-10 align-items-center justify-content-end w-100">
              <p class="service-card-text my-3">
                End-to-end academic and personal projects involving data
                <br />
                cleaning, modeling, insights, and reporting.
              </p>
              <div
                class="service-card-icon icon-shape ms-auto icon-md rounded-circle border">
                <i class="ri-arrow-right-up-line"></i>
      ...
      <div
  data-shortcode-id="sc_1770725038_0"
  data-shortcode-name="projects"
  id="projects"
  class="section-projects-1 position-relative pt-120 pb-6 bg-900 shortcode-lazy-loading-loaded">
  <div class="container">
    <div class="row align-items-end">
      <div class="col-lg-7 me-auto">
        <h3 class="ds-3 mt-3 mb-3 text-primary">My Projects & Research Work</h3>
        <span class="fs-5 fw-medium text-200">
          I focus on building end-to-end data science, machine learning, and AI solutions
          <br />
          with strong mathematical foundations and real-world impact.
        </span>
      </div>
    </div>
  </div>
...
<div class="bg-900 fillter-project">
  <div class="container">
    <div class="text-start">
      <div class="button-group filter-button-group filter-menu-active">
        <button
          class="btn btn-md btn-filter mb-2 me-2 text-uppercase active"
          data-filter="*">
          All Projects
        </button>
        <button
          class="btn btn-md btn-filter mb-2 me-2 text-uppercase"
    ...
    <div
      class="row masonry-active justify-content-between mt-6"
      style="position: relative; height: 1187.12px">
      <div class="grid-sizer"></div>

      <!-- Project 1 -->
      <div
        class="filter-item col-lg-6 col-12 development"
        style="position: absolute; left: 0px; top: 0px">
        <div
          class="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
          <a href="#">
            <img
              src="asset/21.png"
              data-bb-lazy="true"
              class="rounded-3 w-100 zoom-img"
              loading="lazy"
              alt="Business Intelligence Insights" />
          </a>
          <div class="d-flex align-items-center mt-4">
            <a href="#" class="project-card-content">
              <h3 class="fw-semibold">Business Intelligence Insights</h3>
              <p>EDA & SQL Analytics Project</p>
            </a>
            <a
              href="#"
      ...
      <!-- Project 2 -->
      <div
        class="filter-item col-lg-6 col-12 design"
        ...
        <div
          ...
          <div class="d-flex align-items-center mt-4">
            <a href="#" class="project-card-content">
              <h3 class="fw-semibold">Predictive Analytics Engine</h3>
      ...
      <!-- Project 3 -->
      <div
        class="filter-item col-lg-6 col-12 development design"
        style="position: absolute; left: 0px; top: 572.562px">
        <div
          class="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
          <a href="#">
            <img
              ...
              class="rounded-3 w-100 zoom-img"
              loading="lazy"
              alt="Neural Network Implementation" />
          </a>
          <div class="d-flex align-items-center mt-4">
            <a href="#" class="project-card-content">
              <h3 class="fw-semibold">Neural Network Implementation</h3>
      ...
      <!-- Project 4 -->
      <div
        class="filter-item col-lg-6 col-12 marketing content"
        style="position: absolute; left: 570px; top: 572.562px">
        <div
          class="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
          <a href="#">
            <img
          ...
          <div class="d-flex align-items-center mt-4">
            <a href="#" class="project-card-content">
              <h3 class="fw-semibold">NLP Sentiment Analysis System</h3>
              <p>Natural Language Processing Case Study</p>
            </a>
            <a
              href="#"
      ...
      <section
        data-shortcode-id="sc_1770725038_0"
        data-shortcode-name="resume"
        id="resume"
        class="section-resume-1 position-relative pt-150 overflow-hidden shortcode-lazy-loading-loaded"
        data-background="asset/grid-bg.png"
        style="
          background-image: url(&quot;asset/grid-bg.png&quot;);
      ...
      >
        <div class="container">
          <div class="row align-items-end">
            ...
            <div class="col-lg-auto">
              <a
                href="#contact"
                class="btn btn-gradient mt-lg-0 mt-5 ms-lg-auto"
              >
                Get in touch
                <i class="ri-arrow-right-up-line"></i>
              </a>
          ...
          <div class="row mt-6 row-cols-1 row-cols-lg-2">
            <div class="col">
              <div class="resume-card p-lg-6 p-4 mb-lg-0 mb-6">
                <div class="resume-card-header d-flex align-items-end">
                  <svg
                    class="icon border-linear-1 border-3 pb-2 pe-2 svg-icon-ti-ti-school"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  <h3
                    class="fw-semibold mb-0 border-bottom border-600 border-3 pb-2 w-100"
                  >
                    Education
                  </h3>
                </div>
                <div class="resume-card-body">
                  <div class="resume-card-item px-4 py-3 mt-5">
                    <div class="d-flex align-items-end">
                      ...
                      <h3 class="text-linear-1 ms-auto fw-semibold">
                        4.9<span class="fs-4 fw-bold">/5</span>
                      </h3>
                    </div>
                  </div>
                  <div class="resume-card-item px-4 py-3 mt-5">
                    <div class="d-flex align-items-end">
                      ...
                      <h3 class="text-linear-1 ms-auto fw-semibold">
                        5.0<span class="fs-4 fw-bold">/5</span>
                      </h3>
                    </div>
                  </div>
                  <div class="resume-card-item px-4 py-3 mt-5">
                  ...
                  <div class="resume-card-item px-4 py-3 mt-5">
                    <div class="d-flex align-items-end">
                      ...
                      <h3 class="text-linear-1 ms-auto fw-semibold">
                        4.8<span class="fs-4 fw-bold">/5</span>
                      </h3>
                    </div>
                  </div>
                </div>
            ...
            <div class="col">
              <div class="resume-card p-lg-6 p-4 mb-lg-0 mb-6">
                <div class="resume-card-header d-flex align-items-end">
                  <svg
                    class="icon border-linear-1 border-3 pb-2 pe-2 svg-icon-ti-ti-stars"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <div class="resume-card-body">
                  <div class="resume-card-item px-4 py-3 mt-5">
                    <div class="d-flex align-items-end">
                      ...
                      <h3 class="text-linear-1 ms-auto fw-semibold"></h3>
                    </div>
                  </div>
                  <div class="resume-card-item px-4 py-3 mt-5">
                    <div class="d-flex align-items-end">
        ...
        <div class="scroll-move-right position-relative pb-160 pt-lg-150">
          ...
          >
            <h3 class="stroke fs-150 text-uppercase text-white">
      ...
      <section
        data-shortcode-id="sc_1770725038_0"
        data-shortcode-name="skills"
        class="section-skills-1 position-relative section-padding bg-900 shortcode-lazy-loading-loaded"
      >
        <div class="container">
          <div class="row">
            ...
            <div
              class="d-flex flex-wrap flex-lg-nowrap justify-content-center gap-0 gap-lg-3 mb-7 px-4 px-lg-6"
            >
              <div class="skills">
                ...
                <div class="skills-ratio text-center">
                  <h3 class="count fw-semibold my-0">
                    <span class="odometer fw-semibold" data-count="92">92</span
                    >%
                  </h3>
              ...
              <div class="skills">
                ...
                <div class="skills-ratio text-center">
                  <h3 class="count fw-semibold my-0">
                    <span class="odometer fw-semibold" data-count="87">87</span
                    >%
                  </h3>
              ...
              <div class="skills">
                ...
                <div class="skills-ratio text-center">
                  <h3 class="count fw-semibold my-0">
                    <span class="odometer fw-semibold" data-count="82">82</span
                    >%
                  </h3>
              ...
              <div class="skills">
                ...
                <div class="skills-ratio text-center">
                  <h3 class="count fw-semibold my-0">
                    <span class="odometer fw-semibold" data-count="84">84</span
                    >%
                  </h3>
              ...
              <div class="skills">
                ...
                <div class="skills-ratio text-center">
                  <h3 class="count fw-semibold my-0">
                    <span class="odometer fw-semibold" data-count="86">86</span
                    >%
                  </h3>
              ...
              <div class="skills">
                ...
                <div class="skills-ratio text-center">
                  <h3 class="count fw-semibold my-0">
                    <span class="odometer fw-semibold" data-count="70">70</span
                    >%
                  </h3>
              ...
              <div class="skills">
                ...
                <div class="skills-ratio text-center">
                  <h3 class="count fw-semibold my-0">
                    <span class="odometer fw-semibold" data-count="76">76</span
                    >%
                  </h3>
            ...
            <div class="text-center">
              <p class="fs-5 text-200 mb-0">
                In addition, I have some programming knowledge such as: <br />
                <span class="fs-5 fw-bold text-dark"
                  >HTML, CSS, Javascript, Bootstrap, TailwindCSS</span
                >
              </p>
            </div>
          </div>
      ...
      <section
        data-shortcode-id="sc_1770725038_0"
        data-shortcode-name="image-slider"
        class="section-brands-1 section-padding shortcode-lazy-loading-loaded"
      >
        <div class="container">
          <div class="text-center">
            <h2>Trusted by industry leaders</h2>
            <p class="text-300">
              I have collaborated with many large corporations, companies, and
              agencies around <br />
        ...
        <div class="container-fluid">
          <div
            class="slick-slider mt-5 position-relative z-1 slick-initialized"
            data-items="8"
          >
            <div class="slick-list draggable">
              ...
              >
                <div
                  class="slick-slider-item slick-slide slick-cloned"
                  data-slick-index="-8"
                  id=""
                  aria-hidden="true"
                  tabindex="-1"
                  style="width: 166px"
                >
                  <a href="https://Discord.com" target="_blank" tabindex="-1">
                    <img
                      src="asset/33.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://jump.com" target="_blank" tabindex="-1">
                    <img
                      src="asset/35.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://MetaMask.com" target="_blank" tabindex="-1">
                    <img
                      src="asset/37.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://Shopify.com" target="_blank" tabindex="-1">
                    <img
                      src="asset/38.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://Stripe.com" target="_blank" tabindex="-1">
                    <img
                      src="asset/39.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  class="slick-slider-item slick-slide"
                  data-slick-index="0"
                  aria-hidden="true"
                  tabindex="-1"
                  style="width: 166px"
                >
                  <a href="https://Brave.com" target="_blank" tabindex="-1">
                    <img
                      src="asset/31.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://Circle.com" target="_blank" tabindex="-1">
                    <img
                      src="asset/32.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://Shopify.com" target="_blank" tabindex="0">
                    <img
                      src="asset/38.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  class="slick-slider-item slick-slide slick-current slick-active"
                  data-slick-index="8"
                  aria-hidden="false"
                  tabindex="0"
                  style="width: 166px"
                >
                  <a href="https://Stripe.com" target="_blank" tabindex="0">
                    <img
                      src="asset/39.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  class="slick-slider-item slick-slide slick-active"
                  data-slick-index="9"
                  aria-hidden="false"
                  tabindex="0"
                  style="width: 166px"
                ...
                <div
                  class="slick-slider-item slick-slide slick-cloned slick-active"
                  data-slick-index="10"
                  id=""
                  aria-hidden="false"
                  tabindex="-1"
                  style="width: 166px"
                >
                  <a href="https://Brave.com" target="_blank" tabindex="0">
                    <img
                      src="asset/31.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://Circle.com" target="_blank" tabindex="0">
                    <img
                      src="asset/32.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://Discord.com" target="_blank" tabindex="0">
                    <img
                      src="asset/33.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://Google.com" target="_blank" tabindex="0">
                    <img
                      src="asset/34.png"
                      data-bb-lazy="true"
                      loading="lazy"
                ...
                <div
                  ...
                  style="width: 166px"
                >
                  <a href="https://jump.com" target="_blank" tabindex="0">
                    <img
                      src="asset/35.png"
                      data-bb-lazy="true"
                      loading="lazy"
      ...
      <section
        data-shortcode-id="sc_1770725038_0"
        data-shortcode-name="testimonials"
        class="section-testimonials-1 position-relative pt-120 pb-120 bg-900 overflow-hidden mb-8 shortcode-lazy-loading-loaded"
      >
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <div class="row mt-8">
                <div
                  class="swiper slider-2 pt-2 pb-3 swiper-initialized swiper-horizontal swiper-backface-hidden"
                  data-slides-per-view="2"
                >
                  <div
                    class="swiper-wrapper"
                    id="swiper-wrapper-d913cf542660196a"
                    aria-live="off"
                    style="
                  ...
                  >
                    <div
                      ...
                      style="width: 365px; margin-right: 30px"
                    >
                      <div
                      ...
                      >
                        ...
                        <div class="h6 mb-7 testimonials-content">
                          “The guidance and insights provided by this team were
                          invaluable in helping me secure profitable
                          investments. Their market knowledge and dedication to
                          client success are unmatched.”
                        </div>
                        <a href="#" class="d-flex align-items-center">
                          <img
                            src="asset/1.png"
                            data-bb-lazy="true"
                            class="icon_65 avatar"
                            loading="lazy"
                            alt="Robert Evans"
                          />
                          <h6 class="ms-2 mb-0">
                            Robert Evans
                            <span class="fs-6 fw-regular">
                              - Property Investor</span
                            >
                          </h6>
                        </a>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="h6 mb-7 testimonials-content">
                          “I couldn’t have asked for a smoother selling
                          experience. Their expert advice, flawless staging, and
                          negotiation skills resulted in a quick sale at a great
                          price. Truly impressive!”
                        </div>
                        <a href="#" class="d-flex align-items-center">
                          <img
                            src="asset/1.png"
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="h6 mb-7 testimonials-content">
                          “From start to finish, the home buying experience was
                          handled with care and professionalism. The team
                          listened to all my concerns and helped me find the
                          perfect home in no time.”
                        </div>
                        <a href="#" class="d-flex align-items-center">
                          <img
                            src="asset/1.png"
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="h6 mb-7 testimonials-content">
                          ...
                          Their attention to detail, professionalism, and
                          understanding of my needs made the entire home buying
        ...
        <div
          class="shape-1 position-absolute bottom-0 start-50 z-1 ms-10 ps-10 d-none d-md-block"
        >
          <img
            src="asset/man.png"
            data-bb-lazy="true"
            ...
            loading="lazy"
            alt="Client's Testimonials"
          />
        </div>
      </section>
      <section
        data-shortcode-id="sc_1770725038_0"
        data-shortcode-name="blog-posts"
        class="section-blog-1 position-relative pt-60 pb-60 shortcode-lazy-loading-loaded"
      >
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7 me-auto">
              <h3 class="ds-3 mt-3 mb-3 text-primary">Recent blog</h3>
              <span class="fs-5 fw-medium text-200"
                >Explore the insights and trends shaping our industry</span
              >
            </div>
            <div class="col-lg-auto">
              <a href="/blog" class="btn btn-gradient mt-lg-0 mt-5 ms-lg-auto">
                View more
                <i class="ri-arrow-right-up-line"></i>
              </a>
            </div>
          ...
          <div class="row mt-8 row-cols-1 row-cols-md-3">
            <div class="col">
              <div class="blog-card rounded-4 mb-lg-3 mb-md-5 mb-3">
                <div class="blog-card__image position-relative">
                  <div class="zoom-img rounded-3 overflow-hidden">
                    <img
                      ...
                      data-bb-lazy="true"
                      loading="lazy"
                      alt="A Deep Dive into Laravel for Beginners"
                    />
                    <a
                      class="position-absolute bottom-0 start-0 m-3 text-white-keep btn btn-gradient fw-medium rounded-3 px-3 py-2"
                      href="#"
                    >
                      Design Portfolio
                    </a>
                ...
                <div
                  class="blog-card__content position-relative text-center mt-4"
                >
                  <span class="blog-card__date fs-7"
                    >Nov 25, 2024 • 2 min read</span
                  >
                  <div class="h5 blog-card__title text-truncate">
                    A Deep Dive into Laravel for Beginners
                  </div>
                  <p class="blog-card__description fs-6">
                    A comprehensive guide for beginners who want to learn
                    Laravel, covering everything from installation...
                  </p>
                  <a
                    href="#"
            ...
            <div class="col">
              <div class="blog-card rounded-4 mb-lg-3 mb-md-5 mb-3">
                <div class="blog-card__image position-relative">
                  <div class="zoom-img rounded-3 overflow-hidden">
                    <img
                      ...
                      data-bb-lazy="true"
                      loading="lazy"
                      alt="How to Integrate APIs in Node.js for Your Next Project"
                    />
                    <a
                      class="position-absolute bottom-0 start-0 m-3 text-white-keep btn btn-gradient fw-medium rounded-3 px-3 py-2"
                      href="#"
                ...
                >
                  <span class="blog-card__date fs-7"
                    >Nov 10, 2024 • 2 min read</span
                  >
                  <div class="h5 blog-card__title text-truncate">
                    How to Integrate APIs in Node.js for Your Next Project
                  </div>
                  <p class="blog-card__description fs-6">
                    Learn how to seamlessly integrate third-party APIs in your
                    Node.js applications for powerful data ac...
                  </p>
                  <a
                    href="#"
                    class="link-overlay position-absolute top-0 start-0 w-100 h-100"
            ...
            <div class="col">
              <div class="blog-card rounded-4 mb-lg-3 mb-md-5 mb-3">
                <div class="blog-card__image position-relative">
                  <div class="zoom-img rounded-3 overflow-hidden">
                    <img
                      ...
                      data-bb-lazy="true"
                      loading="lazy"
                      alt="Best Practices for Designing User-Friendly Websites"
                    />
                    <a
                      class="position-absolute bottom-0 start-0 m-3 text-white-keep btn btn-gradient fw-medium rounded-3 px-3 py-2"
                      href="#"
                ...
                >
                  <span class="blog-card__date fs-7"
                    >Oct 18, 2024 • 2 min read</span
                  >
                  <div class="h5 blog-card__title text-truncate">
                    Best Practices for Designing User-Friendly Websites
                  </div>
                  <p class="blog-card__description fs-6">
                    Discover the best practices for designing websites that are
      ...
      >
        <div class="container position-relative z-1">
          ...
          <div class="row mt-8">
            <div class="col-lg-4 d-flex flex-column">
              <div
                class="d-flex align-items-center mb-4 position-relative d-inline-flex"
              >
                <div
                  class="bg-white icon-flip position-relative icon-shape icon-xxl border-linear-2 border-2 rounded-4"
                >
                  <svg
                    class="icon text-primary svg-icon-ti-ti-phone"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              >
                ...
                >
                  <svg
                    class="icon text-primary svg-icon-ti-ti-mail"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <div class="ps-3">
                  <span class="text-400 fs-5">Email</span>
                  <h6 class="mb-0">contact@botble.com</h6>
                </div>
                <a
                  href="mailto:contact@botble.com"
                  class="position-absolute top-0 start-0 w-100 h-100"
                  title="Email"
                ></a>
              </div>
              ...
              >
                ...
                >
                  <svg
                    class="icon text-primary svg-icon-ti-ti-user"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <div class="ps-3">
                  <span class="text-400 fs-5">X (Twitter)</span>
                  <h6 class="mb-0">Botble Technologies</h6>
                </div>
                <a
                  href="https://x.com/botble"
                  class="position-absolute top-0 start-0 w-100 h-100"
                  title="X (Twitter)"
                ></a>
              </div>
              ...
              >
                ...
                >
                  <svg
                    class="icon text-primary svg-icon-ti-ti-map"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div class="ps-lg-0 pt-5 pt-lg-0 col-lg-7 offset-lg-1">
              <div class="position-relative">
                <div class="position-relative z-2">
                  ...
                  <form
                    ...
                    id="botble-contact-forms-fronts-contact-form"
                    class="contact-form dirty-check"
                    novalidate="novalidate"
                  >
                    <input
                      name="_token"
                      type="hidden"
                      value="sYQeAGFSif53XZP4O1QzkG67ZJ0ynHA0GZPmUTtz"
                    /><input
                      class="form-control"
                      data-counter="250"
                    ...
                    /><input
                      ...
                      name="display_fields"
                      type="hidden"
                      value="phone,email,subject,address"
                    />
                    <div class="contact-form-row row">
                      <div
                        class="contact-column-6 col-md-6 contact-field-name_wrapper"
                      >
                        <div class="contact-form-group">
                          <label
                            class="form-label mb-3 mt-3 text-dark required"
                            for="name"
                          >
                            Name </label
                          ><input
                      ...
                      <div
                        class="contact-column-6 col-md-6 contact-field-email_wrapper"
                      >
                        <div class="contact-form-group">
                          <label
                            class="form-label mb-3 mt-3 text-dark required"
                      ...
                      <div
                        class="contact-column-6 col-md-6 contact-field-address_wrapper"
                      >
                        <div class="contact-form-group">
                          <label
                            class="form-label mb-3 mt-3 text-dark"
                            for="address"
                          >
                            Address </label
                          ><input
                      ...
                      <div
                        class="contact-column-6 col-md-6 contact-field-phone_wrapper"
                      >
                        <div class="contact-form-group">
                          <label
                            class="form-label mb-3 mt-3 text-dark"
                          ...
                          >
                            Phone </label
                          ><input
                            class="form-control border rounded-3 js-phone-number-mask form-control"
                            data-counter="25"
                            placeholder="Your Phone"
                            id="phone-field-qIkqvf0K"
                    ...
                    <div class="contact-form-group">
                      <input
                        ...
                        value="0"
                      /><label class="mb-3 mt-3 text-dark required form-check"
                        ><input
                          type="checkbox"
                          id="agree_terms_and_policy_243f28785407323f2c450d79cc588bc4"
                          name="agree_terms_and_policy"
                          class="form-check-input border rounded-3"
                          required="required"
                          value="1"
                          aria-required="true"
                    ...
                    <div class="contact-form-group">
                      <div
                        class="contact-message contact-success-message page_speed_1912032830"
                      ></div>
                      <div
                        class="contact-message contact-error-message page_speed_1912032830"
                      ></div>
                    </div>
                    <button class="btn btn-gradient mt-3" type="submit">
        ...
        <div
          class="scroll-move-right position-absolute bottom-0 start-50 translate-middle-x bg-900 overflow-hidden page_speed_1318966020"
          style="
            translate: none;
            rotate: none;
            scale: none;
            transform: translate(-908.43px, 0px);
          "
        >
          <div
            class="wow img-custom-anim-top page_speed_1011913157"
            style="visibility: hidden; animation-name: none"
          >
            <h3 class="stroke fs-280 text-lowercase text-900 mb-0 lh-1">
              william.design
            </h3>
          </div>
        </div>
        ...
        <div class="text-center container position-relative z-1">
          <a
            ...
            ><img
              ...
              class="page_speed_1711549805"
              alt="Showcasing Creative Designs and Innovative Projects"
            /><span class="fs-4 ms-2 site-name-text text-white-keep"
              >william.design</span
            ></a
          >
          <div
          ...
          <div class="row text-center py-4">
            <span class="fs-6 text-white-keep">
              ...
              <a href="https://botble.com" class="text-primary">botble.com</a>.
            </span>
          </div>
        </div>
        <div
          class="position-absolute top-0 start-0 w-100 h-100 z-0"
          data-background="asset/footer-bg.png"
          style="
      ...
      >
        <path
          ...
          style="
            ...
            stroke-dasharray: 139.989, 139.989;
            stroke-dashoffset: 139.989;
          "
        ></path>
      </svg>
    </div>
    <script
      ...
      src="asset/jquery-3.7.1.js"
    ></script>
    <script src="asset/bootstrap.bundle.js"></script>
    <script src="asset/swiper-bundle.js"></script>
    <script src="asset/aos.js"></script>
    <script src="asset/wow.js"></script>
    <script src="asset/headhesive.js"></script>
    <script src="asset/smart-stick-nav.js"></script>
    <script src="asset/jquery.magnific-popup.js"></script>
    <script src="asset/gsap.js"></script>
    <script src="asset/imagesloaded.pkgd.js"></script>
    <script src="asset/isotope.pkgd.js"></script>
    <script src="asset/ScrollToPlugin.js"></script>
    <script src="asset/ScrollTrigger.min.js"></script>
    <script src="asset/jquery.carouselTicker.js"></script>
    <script src="asset/slick.js"></script>
    <script src="asset/jquery.appear.js?v=1.2.4"></script>
    <script src="asset/gsap-custom.js?v=1.2.4"></script>
    <script src="asset/imageRevealHover.js?v=1.2.4"></script>
    <script src="asset/aat.js"></script>
    <script src="asset/color-modes.js?v=1.2.4"></script>
    <script src="asset/main.js?v=1.2.4"></script>
    <script src="asset/theme.js?v=1.2.4"></script>
    <script src="asset/contact-public.js?v=1.0.1"></script>
    <script src="asset/js-validation.js?v=1.0.1"></script>
    <script>
        ...
        $("#botble-contact-forms-fronts-contact-form").each(function () {
          $(this).validate({
            ...
            errorPlacement: function (error, element) {
              if (
                element.closest('[data-bb-toggle="tree-checkboxes"]').length
              ) {
                error.insertAfter(
                  element.closest('[data-bb-toggle="tree-checkboxes"]'),
                );
              } else if (
            ...
            focusInvalid: false,
            rules: JSON.parse(
              "{\u0022name\u0022:{\u0022laravelValidation\u0022:[[\u0022Required\u0022,[],\u0022The Name field is required.\u0022,true],[\u0022String\u0022,[],\u0022The Name must be a string.\u0022,false],[\u0022Max\u0022,[\u002240\u0022],\u0022The Name must not be greater than 40 characters.\u0022,false]]},\u0022email\u0022:{\u0022laravelValidation\u0022:[[\u0022Required\u0022,[],\u0022The Email field is required.\u0022,true],[\u0022Max\u0022,[\u002280\u0022],\u0022The Email must not be greater than 80 characters.\u0022,false]],\u0022laravelValidationRemote\u0022:[[{},[\u0022email\u0022,\\u0022,false],\u0022validation.illuminate\\\\_validation\\\\_invokable_validation_rule\u0022,false]]},\u0022content\u0022:{\u0022laravelValidation\u0022:[[\u0022Required\u0022,[],\u0022The Content field is required.\u0022,true],[\u0022String\u0022,[],\u0022The Content must be a string.\u0022,false],[\u0022Max\u0022,[\u002210000\u0022],\u0022The Content must not be greater than 10000 characters.\u0022,false]]},\u0022phone\u0022:{\u0022laravelValidation\u0022:[[\u0022Nullable\u0022,[],\u0022validation.nullable\u0022,false]],\u0022laravelValidationRemote\u0022:[[{},[\u0022phone\u0022,\\u0022,false],\u0022validation.illuminate\\\\_validation\\\\_invokable_validation_rule\u0022,false]]},\u0022address\u0022:{\u0022laravelValidation\u0022:[[\u0022Nullable\u0022,[],\u0022validation.nullable\u0022,false],[\u0022String\u0022,[],\u0022The Address must be a string.\u0022,false],[\u0022Max\u0022,[\u0022500\u0022],\u0022The Address must not be greater than 500 characters.\u0022,false]]},\u0022subject\u0022:{\u0022laravelValidation\u0022:[[\u0022Required\u0022,[],\u0022The Subject field is required.\u0022,true],[\u0022String\u0022,[],\u0022The Subject must be a string.\u0022,false],[\u0022Max\u0022,[\u0022500\u0022],\u0022The Subject must not be greater than 500 characters.\u0022,false]]},\u0022agree_terms_and_policy\u0022:{\u0022laravelValidation\u0022:[[\u0022Required\u0022,[],\u0022The Agree terms and policy field is required.\u0022,true],[\u0022Accepted\u0022,[\u00221\u0022],\u0022You must agree to the terms and policy.\u0022,true]]}}",
            ),
          });
        });
      });
    </script>
    <script src="asset/language-public.js?v=2.2.0"></script>
    <script>
    ...
    <script src="asset/toast.js?v=1.2.4"></script>
    <script src="asset/announcement.js?v=1.2.4"></script>
    <script>
      var lazyLoadShortcodeBlocks = function () {
        document
          .querySelectorAll(".shortcode-lazy-loading")
          .forEach(function (element) {
            ...
            const url = "{{asset('/')}}";
            const csrfToken = "sYQeAGFSif53XZP4O1QzkG67ZJ0ynHA0GZPmUTtz";
            ...
            fetch(url, {
              ...
              .then(({ error, data }) => {
                ...
                if (firstChild) {
                  ...
                  if (
                    shortcodeId &&
                    !firstChild.getAttribute("data-shortcode-id")
                  ) {
                ...
                document.dispatchEvent(
                  new CustomEvent("shortcode.loaded", {
                    detail: { name, attributes, html: data },
                  }),
                );
                if (
                  typeof Theme !== "undefined" &&
                  typeof Theme.lazyLoadInstance !== "undefined"
                ) {
    ...
    <div
      dir="ltr"
      data-nosnippet=""
      class="js-site-notice site-notice site-notice-full-width page_speed_399634552"
      style="display: none"
    >
      <div class="site-notice-body page_speed_1307486709">
        <div class="site-notice__inner">
          ...
          <div class="site-notice__actions">
            <button
              class="js-site-notice-reject site-notice__reject page_speed_2100131830"
            >
              Reject</button
            ><button
              class="js-site-notice-customize site-notice__customize page_speed_2100131830"
            >
              Customize preferences</button
            ><button
              class="js-site-notice-agree site-notice__agree page_speed_1755834137"
            >
              Accept cookies
            </button>
          </div>
        </div>
        <div class="site-notice__categories" style="display: none">
          <div class="cookie-category">
            <label class="cookie-category__label"
              ><input
                ...
                checked=""
                disabled=""
              /><span class="cookie-category__name">Essential</span></label
            >
          ...
          <div class="cookie-category">
            <label class="cookie-category__label"
              ><input
                ...
                value="analytics"
                class="js-cookie-category"
              /><span class="cookie-category__name">Analytics</span></label
            >
            <p class="cookie-category__description">
          ...
          <div class="cookie-category">
            <label class="cookie-category__label"
              ><input
                ...
                value="marketing"
                class="js-cookie-category"
              /><span class="cookie-category__name">Marketing</span></label
            >
            <p class="cookie-category__description">
          ...
          <div class="site-notice__save">
            <button
              class="js-site-notice-save site-notice__save-button page_speed_1755834137"
            >
              Save preferences
            </button>
          </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        setTimeout(function () {
          const cookieName =
            document
              .querySelector("div[data-site-cookie-name]")
              .getAttribute("data-site-cookie-name") || "cookie_for_consent";
      ...
      window.addEventListener("load", function () {
        ...
        window.botbleCookieConsent = (function () {
          ...
          const COOKIE_DOMAIN =
            document
              .querySelector("div[data-site-cookie-domain]")
              .getAttribute("data-site-cookie-domain") ||
            window.location.hostname;
          const COOKIE_LIFETIME = parseInt(
            document
              .querySelector("div[data-site-cookie-lifetime]")
              .getAttribute("data-site-cookie-lifetime") || "36000",
            10,
          );
          const SESSION_SECURE =
            document
              .querySelector("div[data-site-session-secure]")
              .getAttribute("data-site-session-secure") || "";
          const cookieDialog = document.querySelector(".js-site-notice");
          const cookieCategories = document.querySelector(
            ".site-notice__categories",
          );
          const customizeButton = document.querySelector(
            ".js-site-notice-customize",
          );
          if (cookieDialog) {
            if (cookieCategories) {
          ...
          function consentWithCookies() {
            const categories = {};
            document
              .querySelectorAll(".js-cookie-category:checked")
          ...
          document.addEventListener("click", function (event) {
            if (event.target.classList.contains("js-site-notice-agree")) {
              ...
              event.target.classList.contains("js-site-notice-reject")
            ) {
              rejectAllCookies();
            } else if (
              event.target.classList.contains("js-site-notice-customize")
            ) {
              toggleCustomizeView();
      ...
      (function () {
        function c() {
          ...
          if (b) {
            ...
            d.innerHTML =
              "window.__CF$cv$params={r:'9cbb774a3c612a90',t:'MTc3MDcyNTAzNA=='};var a=document.createElement('script');a.src='asset/main.js';document.getElementsByTagName('head')[0].appendChild(a);";
